...
export default function AppLoader() {
  ...
  return (
    ...
    >
      <span
        className={`${lamaSans.className} text-white/90`}
        style={{ fontSize: 'clamp(14px, 1.9vw, 24px)', letterSpacing: '0.15em' }}
      >
        ORYX
      </span>
      ...
      <span className="font-mono text-[10px] tracking-[0.45em] text-white/30 uppercase">
        INITIALIZING
      </span>
    </div>
  )
